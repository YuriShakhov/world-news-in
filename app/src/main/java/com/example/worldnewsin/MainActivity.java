...
public final class MainActivity extends Activity implements OnFullscreenListener {
    ...
    public VideoListFragment listFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Resources.Settings.restoreSettings(this);
        presenter.setNewVideoList();
    ...
    private void init() {
        Spinner languagesList = findViewById(R.id.chooseLanguage);
        ArrayList<String> languages = new ArrayList<>(Resources.channelsMenu.keySet());
        ArrayAdapter<String> chooseLanguageAdapter = new ArrayAdapter<String>(this,
                android.R.layout.simple_list_item_1, languages);
        languagesList.setAdapter(chooseLanguageAdapter);
        int spinnerPosition = chooseLanguageAdapter.getPosition(Resources.Settings.getCurrentLanguage());
        ...
        languagesList.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                String language = textView != null ? textView.getText().toString() : Resources.Settings.getCurrentLanguage();
                presenter.getList(language);
            }
    ...
    public void renew (View view) {
        presenter.getList(Resources.Settings.getCurrentLanguage());
    }

    public void setVideosList (List<MainActivity.VideoEntry> list) {
    ...
    public static final class VideoListFragment extends ListFragment {
        ...
        private static List<VideoEntry> VIDEO_LIST = new ArrayList<>();
        private PageAdapter pageAdapter;
        private View videoBox;

        public void setList (List<VideoEntry> newList) {
            VIDEO_LIST.clear();
            VIDEO_LIST.addAll(newList);
            Log.d(TAG, String.valueOf(VIDEO_LIST.size()));
            Log.d(TAG, VIDEO_LIST.toString());
        }

        public void renewAdapter () {
            pageAdapter = new PageAdapter(getActivity(), VIDEO_LIST);
    ...
    public static final class VideoEntry {
        ...
        public VideoEntry(String text, String videoId, String date) {
            this.text = text;
            this.videoId = videoId;
            this.date = date;
        }
